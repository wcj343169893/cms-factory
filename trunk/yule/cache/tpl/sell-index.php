...
<link rel="stylesheet" type="text/css" href="<?php echo DT_SKIN;?>css/sell_list.css"/>
<script type="text/javascript" src="<?php echo DT_SKIN;?>js/sell.js"></script>

<div class="m950">
<div class="m_l_760 f_l">
	<div class="left_box">
		<div class="pos">当前位置: <a href="<?php echo DT_PATH;?>">首页</a>
		>  <a href="<?php echo $MOD['linkurl'];?>"><?php echo $MOD['name'];?></a>
		<?php if($typeid!=99) { ?>>  <a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('index.php?typeid='.$typeid);?>"><?php echo $TYPE[$typeid];?></a><?php } ?>
		<?php if($catid) { ?> >  <?php echo cat_pos($catid);?><?php } ?>
		</div>
	<div class="class-name">
		<div class="class-name-btn">
			<strong>按行业选择：</strong>
			<div><a href="#" onclick="showHCate(this);return false;" id="show_all">显示所有</a></div>
		</div>
		<div class="class-name-ele">
			<ul class="class-name-item">
		    	<?php if(is_array($maincat)) { foreach($maincat as $k => $v) { ?>
                    <?php if($k<16) { ?>
			     	<li><a href="<?php echo $MOD['linkurl'];?><?php echo $v['linkurl'];?>"><?php echo set_style($v['catname'],$v['style']);?></a><span class="f_gray px10">(<?php echo $ITEMS[$v['catid']];?>)</span></li>
                    <?php } else { ?>
			       	<li class="spanhidden"><a href="<?php echo $MOD['linkurl'];?><?php echo $v['linkurl'];?>"><?php echo set_style($v['catname'],$v['style']);?></a><span class="f_gray px10">(<?php echo $ITEMS[$v['catid']];?>)</span></li><?php } ?>
		    	<?php } } ?>
		  </ul>
		</div>
	</div>
...
<div class="box_bodyali">
   <div class="expo-hd"><a href="#" target="_blank" class="expo-title"><span>企业品牌展播</span></a> <a class="expo-login" href="">加入</a></div> 
   ...
   <div id="gold_ads_v2">
           <div class="hz_adbox">
              <div class="imgbox_relative">
                   <div class="imgbox">
                   <div class="ad_pic">
                   <a href="#" title="#" target="_blank"><img src="<?php echo DT_SKIN;?>images/jnweikai-ffsyfz-2.jpg" width="178" height="209"/></a>
                   </div>
                   </div>
              </div>
             </div>
