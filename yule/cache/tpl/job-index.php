...
<div class="left_box">
<img src="<?php echo DT_SKIN;?>images/job/658X90.jpg" alt="" width="638" height="90" /> 
</div>
...
<div class="m_r f_l">
  ...
  <div class="fl w290">
  	  <div class="cf imglist">
        <a target="_blank" href="#"><img height="100" alt="亚太物业公司" width="300" src="<?php echo DT_SKIN;?>images/job/job-ad001.gif" /></a>
        <ul>
        <li class="m_10"><a target="_blank" href="#"><img height="100" alt="深圳市瑞利特印刷有限公司" width="143" src="<?php echo DT_SKIN;?>images/job/job-ad002.gif" /></a></li>
        <li><a target="_blank" href="#"><img height="100" alt="鸿盛丰五金制品有限公司" width="143" src="<?php echo DT_SKIN;?>images/job/job-ad003.gif" /></a></li>
        <li class="m_10"><a target="_blank" href="#"><img height="100" alt="深圳犀鸟伊东贸易" width="143" src="<?php echo DT_SKIN;?>images/job/job-ad004.gif" /></a></li>
        <li><a target="_blank" href="#"><img height="100" alt="深圳市美之泽服饰辅料有限公司" width="143" src="<?php echo DT_SKIN;?>images/job/job-ad005.gif" /></a></li>
        <li class="m_10"><a target="_blank" href="#"><img height="100" alt="深圳市瑞信华商科技有限公司" width="143" src="<?php echo DT_SKIN;?>images/job/job-ad006.gif" /></a></li>
        <li><a target="_blank" href="#"><img height="100" alt="嘉晟塑料实业有限公司" width="143" src="<?php echo DT_SKIN;?>images/job/job-ad007.gif" /></a></li>
        </ul>
  	  </div> 
  </div> 
